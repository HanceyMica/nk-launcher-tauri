...
const translations: Record<string, TranslationDict> = {
  zh: {
    ...
    simple_bg_enabled: "主界面应用设置背景",
    simple_bg_enabled_desc: "控制主界面（包括简单与专家模式）是否应用自定义背景",
    mode_interop_enabled: "模式互通",
    mode_interop_enabled_desc: "允许简单与专家模式互相识别并执行对方的启动项",
    mode_interop_conflict: "关键字冲突，已优先使用当前模式条目",
    mode_interop_shared_keys: "模式互通：键位 {keys} 在两种模式中均存在，请按标签选择",
    ns_chip_expert: "专",
    ns_chip_simple: "简",
    modify: "修改",
    copy_link: "复制链接",
    copy_app_path: "复制应用路径",
    copy_grid_name: "复制格子名",
    copy_title: "复制标题",
    rename: "重命名",
    add_new_entry: "添加新条目",
    copy: "复制",
    ...
    apply: "应用",
    invalid_hotkey: "快捷键格式无效，至少需要一个修饰键 + 一个普通键",
    prev_step: "上一步",
    next_step: "下一步",
  ...
  en: {
    ...
    simple_bg_enabled: "Apply custom background to main interface",
    simple_bg_enabled_desc: "Controls whether to apply custom background to the main interface (including simple and expert modes)",
    mode_interop_enabled: "Mode Interop",
    mode_interop_enabled_desc: "Allow simple and expert modes to recognize and execute each other's launch items",
    mode_interop_conflict: "Keyword conflict, current mode entry takes priority",
    mode_interop_shared_keys: "Mode interop: keys {keys} exist in both modes — pick by chip",
    ns_chip_expert: "E",
    ns_chip_simple: "S",
    modify: "Modify",
    copy_link: "Copy Link",
    copy_app_path: "Copy App Path",
    copy_grid_name: "Copy Grid Name",
    ...
    apply: "Apply",
    invalid_hotkey: "Invalid hotkey — need at least one modifier + one key",
    prev_step: "Previous",
    next_step: "Next",
  ...
  ja: {
    ...
    simple_bg_enabled: "メインインターフェースにカスタム背景を適用",
    simple_bg_enabled_desc: "メインインターフェース（シンプル/エキスパート両モード含む）にカスタム背景を適用するか制御",
    mode_interop_enabled: "モード相互運用",
    mode_interop_enabled_desc: "シンプルモードとエキスパートモードが互いの起動項目を認識・実行することを許可",
    mode_interop_conflict: "キーワード競合：現在のモードのエントリを優先",
    mode_interop_shared_keys: "モード相互運用：キー {keys} が両モードに存在 — チップで選択",
    ns_chip_expert: "専",
    ns_chip_simple: "簡",
    modify: "変更",
    copy_link: "リンクをコピー",
    copy_app_path: "アプリパスをコピー",
    copy_grid_name: "グリッド名をコピー",
    copy_title: "タイトルをコピー",
    rename: "名前変更",
    add_new_entry: "エントリを追加",
    copy: "コピー",
    paste: "貼り付け",
    commands: "コマンド",
    ...
    apply: "適用",
    invalid_hotkey: "無効なショートカット：少なくとも1つの修飾キーと1つの通常キーが必要です",
    prev_step: "戻る",
    next_step: "次へ",
